...
public class Economy extends Rooms {
    
    String special;
    // Constructor
    public Economy(int roomNumber, roomType type, int price, RoomSize size, String checkInDate, String checkOutDate, String reservationStatus) {
    ...
    public void setImage(checkInUI checkInUI) {
       ImageIcon image = scaleImageIcon((new javax.swing.ImageIcon(getClass().getResource("/EconomyPic.jpg"))), checkInUI.lblIcon);
